...
- `front/`: A customized AI interface with A2A Agent Registry support.
...
This project includes a customized AI platform that features a decentralized **A2A Agent Registry**.
