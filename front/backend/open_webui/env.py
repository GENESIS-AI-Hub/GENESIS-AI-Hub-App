...
WEBUI_FAVICON_URL = "/static/osu-logo.png"
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("osu-genesis-ai-hub")}
else:
    try:
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "osu-genesis-ai-hub")
